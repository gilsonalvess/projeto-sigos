...
<c:url var="actionAlterar" value="/cliente/alterar"></c:url>
...
<div class="w3-padding">
	...
	<form:form class="form-horizontal" action="${actionAlterar}"
		method="post" modelAttribute="cliente">
				<div class="panel-body">
					...
					<div class="panel panel-default">
						...
						<div class="form-group">
							<label class="col-md-2 control-label" for="id">Cod </label>
							<div class="col-md-2">
								<form:input id="id" path="id" placeholder="Apenas números"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<form:input path="razaoSocial" id="razaoSocial"
									name="razaoSocial" placeholder="" class="form-control input-md"
									type="text" />
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								<form:select path="tipoContrato.id" class="form-control"
									...
									<form:options items="${tpcontratos}" itemLabel="descricao" itemValue="id" />
								</form:select>
					...
					<div class="panel panel-default">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<div class="input-group">
									...
									<form:input path="enderecoContato.complemento" id="complemento"
										name="complemento" cssClass="form-control" type="text" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-2">
								<div class="input-group">
									...
									<form:input path="enderecoContato.uf" id="estado" name="estado"
										cssClass="form-control" readonly="readonly" type="text" />
								</div>
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<form:input path="enderecoContato.nomeContato" id="nomeFantasia"
									name="nomeFantasia" cssClass="form-control input-md"
									type="text" />
							</div>
						</div>
					</div>
